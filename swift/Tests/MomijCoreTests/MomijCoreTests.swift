...
final class SeedlessMetalTests: XCTestCase {
    ...
    func testGqmm2SplitKMatchesDefault() throws {
        ...
        try SeedlessMetal.gqmm2(
            ...
            Ktop: Ktop, K: H, N: N, gs: gs, into: enc, splitK: false, w16: false, ternary: false, fold: false)
        try SeedlessMetal.gqmm2(
            x: x, w: w, scales: s, biases: b, inds: inds, out: y1,
            Ktop: Ktop, K: H, N: N, gs: gs, into: enc, splitK: true, w16: false, ternary: false, fold: false)
        enc.endEncoding()
        cb.commit()
        cb.waitUntilCompleted()
    ...
    func testGqmm2TernaryMatchesAffineOnTernaryWeights() throws {
        ...
        try SeedlessMetal.gqmm2(
            x: x, w: w, scales: s, biases: b, inds: inds, out: y1,
            Ktop: Ktop, K: H, N: N, gs: gs, into: enc, splitK: false, w16: false, ternary: true, fold: false)
        enc.endEncoding()
        cb.commit()
        cb.waitUntilCompleted()
    ...
    func testGqmm2FoldMatchesAffineOnTernaryWeights() throws {
        ...
        try SeedlessMetal.gqmm2(
            ...
            ternary: false, fold: false)
        try SeedlessMetal.gqmm2(
            x: x, w: w, scales: s, biases: b, inds: inds, out: y1,
            Ktop: Ktop, K: H, N: N, gs: gs, into: enc, splitK: false, w16: false,
            ternary: false, fold: true)
        enc.endEncoding()
        cb.commit()
        cb.waitUntilCompleted()
    ...
    func testGqmm2W16MatchesDefault() throws {
        ...
        try SeedlessMetal.gqmm2(
            x: x, w: w, scales: s, biases: b, inds: inds, out: y1,
            Ktop: Ktop, K: H, N: N, gs: gs, into: enc, splitK: false, w16: true, ternary: false, fold: false)
        enc.endEncoding()
        cb.commit()
        cb.waitUntilCompleted()
    ...
    func testUpSwigluFusedMatchesSeparate() throws {
        ...
        try SeedlessMetal.gqmm2(
            ...
            Ktop: Ktop, K: H, N: 2 * I, gs: gs, into: enc, ternary: false, fold: false)
